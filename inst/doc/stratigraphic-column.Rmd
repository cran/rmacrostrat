...
```
##   col_id col_group_id       col_name    lat      lng col_area max_thick ref_id status
## 1    489            3 San Juan Basin 35.896 -108.068 35096.52      8040      1 active
##   t_units project_id notes
## 1      47          1    NA
```
